...
import { RdxDrawerRoot, RdxDrawerPopup, RdxDrawerSwipeArea, RdxDrawerVirtualKeyboardProvider } from '../index';
...
<Canvas of={Stories.VirtualKeyboard} />
...
<ArgTypes of={RdxDrawerVirtualKeyboardProvider} />
