...
<Meta title="Primitives/Tooltip-v2" />
...
} from '@radix-ng/primitives/tooltip-v2';`} />

or

<Source type="code" language="typescript" code={`import { RdxTooltipModule } from '@radix-ng/primitives/tooltip-v2';`} />
