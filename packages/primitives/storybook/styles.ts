...
export const demoAccordion = {
    ...
    trigger: cn(
        ...
        // Disabled triggers stay focusable (Base UI parity) via `aria-disabled`, not native
        // `disabled` — style with the `aria-disabled:` variant.
        'aria-disabled:cursor-not-allowed aria-disabled:text-muted-foreground aria-disabled:opacity-60 aria-disabled:hover:bg-background'
    ),
    triggerH: '[writing-mode:vertical-rl] h-full px-0 py-5',
    content: cn(
        'overflow-hidden text-[15px] text-muted-foreground bg-muted',
        '[&[data-open][data-orientation=vertical]]:animate-accordion-down',
        '[&:not([data-open])[data-orientation=vertical]]:animate-accordion-up',
        '[&[data-open][data-orientation=horizontal]]:animate-accordion-right',
        '[&:not([data-open])[data-orientation=horizontal]]:animate-accordion-left',
        ...
        '[&:not([data-open])[data-orientation=vertical]]:h-0',
        '[&:not([data-open])[data-orientation=horizontal]]:w-0'
    ),
