            ...
            >
              <div rdxSelectPopperPositionContent>
                <div class="p-1" rdxSelectViewport>
                  <div class="text-muted-foreground px-6 text-xs leading-6" rdxSelectLabel>Fruits</div>
                  <div rdxSelectGroup>
                  ...
                  <div class="text-muted-foreground px-6 text-xs leading-6" rdxSelectLabel>Vegetables</div>
                  <div rdxSelectGroup>
