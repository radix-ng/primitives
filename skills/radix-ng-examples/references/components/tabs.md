...
<div class="${rootClass}" rdxTabsRoot defaultValue="account">
  ...
  <div class="${panelClass}" rdxTabsPanel value="account">Tabs activate as soon as they receive keyboard focus.</div>
  <div class="${panelClass}" rdxTabsPanel value="password">
    Change your password here. After saving, you'll be logged out.
  </div>
...
<div class="${rootClass} flex w-[520px]" rdxTabsRoot defaultValue="account" orientation="vertical">
  ...
  <div class="${panelClass} flex-1" rdxTabsPanel value="team">Invite teammates and manage their roles.</div>
</div>
```
