...
@Component({
  ...
  template: `
    <div class="flex items-center gap-3">
      ...
      <label class="text-foreground flex items-center text-sm font-medium" rdxLabel htmlFor="r1">I'm a checkbox</label>
    </div>
...
@Component({
  ...
  template: `
    <div class="flex items-center gap-3">
      ...
      <label class="text-foreground text-sm font-medium" rdxLabel htmlFor="sub">Subscribe to the newsletter</label>
    </div>
  ...
  template: `
    <section [formGroup]="personality">
      ...
      <div class="flex items-center gap-3 pb-3">
        ...
        <label class="text-foreground flex items-center text-sm font-medium" rdxLabel htmlFor="r2">Serious</label>
      </div>
